  ...
  return (
    <IonPage>
      ...
      <IonContent fullscreen>
        <IonCard>
          <IonList>
            <IonItem>1. Register for Push by clicking the footer button.</IonItem>
            <IonItem>2. Once registered, you can send push from Firebase console.</IonItem>
            <IonItem>3. Once your app receives notifications, you'll see the data here in the list</IonItem>
          </IonList>
        </IonCard>
